...
3D WebGL visualization of *Neon Genesis Evangelion* canon, rendered as a force-directed graph in the browser. The current dataset spans 88 nodes / 123 edges across characters, the eighteen canonical Angels, the three Magi, EVA units, organizations, locations, concepts, events, and the singular YOU=Lilim audience node.
