...
export const genesis = {
  ...
  kyoko: {
    ...
    primary: "#8a3a3a",
    secondary: ["#d6271e", "#e8d4c4"],
    notes:
      "Asuka's mother. Underwent the Unit-02 contact experiment and lost her mind; her soul fused into the unit. Hanged herself with a rag doll she mistook for Asuka. Surfaced in flashback only.",
  },
  naoko: {
    shortcode: "naoko",
    kind: "CHARACTERS",
  ...
  depression: {
    shortcode: "depression",
    kind: "CONCEPTS",
    displayName: "Depression",
    aliases: ["Depression"],
    primary: "#2a3a4a",
    secondary: ["#1a2a3a", "#5a6a7a"],
    notes:
      "Shinji's defining affliction. The 'I mustn't run away' as a depressive command, the bathwater stillness, the LCL passivity, the closing 'show me your truth' surrender.",
  },
  lanceOfLonginus: {
